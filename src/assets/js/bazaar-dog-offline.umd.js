(function (global, factory) {
	...
	(factory((global.bazaarDogOffline = {})));
 ...
 * Trie Node.
 */
var InvertedIndexNode = /** @class */ (function () {
 ...
 */
var InvertedIndex = /** @class */ (function () {
...
class CachingSearchAPI {
    ...
    setup(seedUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            let url = seedUrl === undefined
                ? 'https://alpha.bazaar.dog/offline_bootstrap.json'
                : seedUrl;
            console.log(url);
            let numberOfKeys = yield this.store.length();
            if (numberOfKeys < 2000) {
                this.cache = yield this.fetchBootstrap(url);
            }
            yield this.buildIndex();
            return this.store.ready();
        });
    }
    fetchBootstrap(endpoint) {
    ...
    getOptions(params) {
        let currencyOptions = this.buildOptions(params['acceptedCurrencies'], this.acceptedCurrenciesMap);
        let nsfwOptions = this.buildOptions(params['nsfw'], this.nsfwMap);
        return {
            acceptedCurrencies: {
    ...
    getResults(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                resultIds = yield this.searchApi.search('Qm');
                console.log('Error in search, searching for nothing ' + error);
            }
            let p = params['p'] === undefined ? 0 : params['p'];
            let ps = params['ps'] === undefined ? 24 : params['ps'];
            const start = p * ps;
            const end = (p + 1) * ps;
            ...
            return Promise.all(cachePromises).then(items => {
                let results = [];
                items
                    .filter((i) => i.acceptedCurrencies[0].startsWith(acceptedCurrencies))
                    .filter((i) => (nsfw === false ? i.nsfw === false : true))
                    .forEach((i) => {
                    try {
...
exports.ListingFlat = ListingFlat;
exports.default = CachingSearchAPI;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=bazaar-dog-offline.umd.js.map
