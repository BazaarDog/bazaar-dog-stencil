  ...
  var api = {
    ...
    subscribe: (0, _postmsgRpc.expose)('ipfs.pubsub.subscribe', function () {
      ...
      return (0, _prepost.pre)(function () {
        ...
        var topic = args[0];
        var handlerIndex = args.length === 3 ? 2 : 1;

        if ((0, _function.isFunctionJson)(args[handlerIndex])) {
          var stubFn = (0, _prepost.pre)(function () {
            ...
            return args;
          }, (0, _postmsgRpc.caller)(args[handlerIndex].name, opts));
    ...
    unsubscribe: (0, _postmsgRpc.expose)('ipfs.pubsub.unsubscribe', (0, _prepost.pre)(function () {
      ...
      return new Promise(function (resolve) {
        ...
        (_getIpfs$pubsub3 = getIpfs().pubsub).unsubscribe.apply(_getIpfs$pubsub3, args);
        resolve();
      });
    }), opts),
    ...
    ls: (0, _postmsgRpc.expose)('ipfs.pubsub.ls', (0, _prepost.pre)(
