...
exports.default = function (opts) {
  ...
  var api = {
    ...
    subscribe: function subscribe(topic, options, handler, cb) {
      var sub = void 0;
      ...
      var stub = (0, _prepost.pre)(function () {
        ...
        args[handlerIndex] = (0, _function.functionToJson)(fnName);
      ...
      if (cb) {
        stub(topic, options, handler).then(function (res) {
    ...
    unsubscribe: (0, _prepost.pre)(function () {
