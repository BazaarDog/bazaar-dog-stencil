...
exports.default = function (opts) {
  return {
    ...
    unwant: _callbackify2.default.variadic((0, _postmsgRpc.caller)('ipfs.bitswap.reprovide', opts)),
    wantlist: _callbackify2.default.variadic((0, _postmsgRpc.caller)('ipfs.bitswap.reprovide', opts))
  };
};
